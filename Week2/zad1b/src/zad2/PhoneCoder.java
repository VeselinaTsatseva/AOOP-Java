...
public class PhoneCoder
{
    ...
    public String encode(String phoneNumber)
    {
        if(phoneNumber != null && phoneNumber.length() == 4)
        {
            ...
            secondDigit = (firstDigit + key) % 10;
            thirdDigit = (firstDigit + key) % 10;
            fourthDigit = (firstDigit + key) % 10;
    ...
    public String decode(String codedPhoneNumber)
    {
        if(codedPhoneNumber != null && codedPhoneNumber.length() == 4)
        {
            ...
            secondDigit = (firstDigit + (10-key)) % 10;
            thirdDigit = (firstDigit + (10-key)) % 10;
            fourthDigit = (firstDigit + (10-key)) % 10;
